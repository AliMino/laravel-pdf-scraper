...
return [
    ...
    'repositories' => [
        ...
        'eloquent' => [
            ...
            UrlScan\IUrlScansRepository::class              => UrlScan\EloquentUrlScansRepository::class,
            UrlScanStatus\IUrlScanStatusesRepository::class => UrlScanStatus\EloquentUrlScanStatusesRepository::class,
        ]
    ]
];